...
import { DottedName, FunFacts } from '@abc-transitionbascarbone/mon-empreinte-festivalier-modele'
import importedFunFacts from '@abc-transitionbascarbone/mon-empreinte-festivalier-modele/public/funFactsRules.json'
